...
# plotting the graph for height
fig = ff.create_distplot([height_list], ["Height(Inches)"], show_hist=False)
...
fig.add_trace(go.Scatter(x=[height_second_std_deviation_start, height_second_std_deviation_start], y=[0, 0.17], mode="lines", name="STANDARD DEVIATION 2"))
fig.add_trace(go.Scatter(x=[height_second_std_deviation_end, height_second_std_deviation_end], y=[0, 0.17], mode="lines", name="STANDARD DEVIATION 2"))
fig.show()
# plotting the graph for weight
#fig = ff.create_distplot([weight_list], ["Weight(Pounds)"], show_hist=False)
#fig.add_trace(go.Scatter(x=[weight_mean,weight_mean], y=[0, 0.17], mode="lines", name="MEAN"))
#fig.add_trace(go.Scatter(x=[weight_first_std_deviation_start, weight_first_std_deviation_start], y=[0, 0.17], mode="lines", name="STANDARD DEVIATION 1"))
#fig.add_trace(go.Scatter(x=[weight_first_std_deviation_end, weight_first_std_deviation_end], y=[0, 0.17], mode="lines", name="STANDARD DEVIATION 1"))
#fig.add_trace(go.Scatter(x=[weight_height_second_std_deviation_start, weight_second_std_deviation_start], y=[0, 0.17], mode="lines", name="STANDARD DEVIATION 2"))
#fig.add_trace(go.Scatter(x=[weight_second_std_deviation_end, weight_second_std_deviation_end], y=[0, 0.17], mode="lines", name="STANDARD DEVIATION 2"))
#fig.show()
